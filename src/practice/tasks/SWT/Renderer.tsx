...
export const SWTRenderer: React.FC<RendererProps> = ({ item, status, theme, onAnswerChange, currentResponse }) => {
  ...
  return (
    <div className="space-y-2">
      ...
      <div className="flex justify-between items-center text-[10px] text-gray-500 font-mono">
        ...
        <span className={wordCount > 0 && (wordCount < 5 || wordCount > 75) ? 'text-red-400 font-bold' : ''}>
